...
import { commentData, recentPost } from '../data/data'
                ...
                <div className="row mt-5 justify-content-center">
                    <div className="col-12">
                        <div className="section-title text-center">
                            <h3 className="sub-title mb-4">Lockdowns lead to fewer people seeking medical care</h3>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8 col-lg-7">
                        <Image src='/images/blog/single.jpg' width={0} height={0} sizes="100vw" style={{width:'100%', height:'auto'}} className="img-fluid rounded shadow" alt=""/>
